...
Usage:
  ...
  hrns init [--docs] [--no-instructions] [--profile node|go|rust|next] [--target PATH] [--home PATH]
...
func printCommandHelp(cmd string) {
	...
	case "init":
		fmt.Println("usage: hrns init [--docs] [--no-instructions] [--profile node|go|rust|next] [--target PATH] [--home PATH]")
	case "docs:check":
